...
- 🚀 **AI Explorer:** Exploring Agentic AI and intelligent automation to build resilient systems
...
- **Frontend & Web:** JavaScript, Chrome Extension Development (Manifest V3).
- **AI/ML:** Gemini API integration, LLM Orchestration, Research Agents.
...
* 🤖 **Agentic Loops:** Research and implementation of autonomous AI workflows.
